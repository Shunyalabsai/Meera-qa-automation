...
test.describe("Global › Language switcher — Search @journey @existing-user @language @positive", () => {
...
test.describe("Global › Language switcher — Search negative @journey @existing-user @language @negative", () => {
