...
test.describe("BUILD › Agents › Appointment reminder — Outcomes tab @journey @appointment-reminder", () => {
  ...
  "newAppointmentDate": "new date if rescheduling was discussed"
    ...
    for (const field of APPOINTMENT_REMINDER_TEMPLATE.defaultExtractionFields) {
