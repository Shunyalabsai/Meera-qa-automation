...
test.describe("BUILD › Agents › Credit Card Payment Reminder — Behaviour tab @journey @credit-card-payment-reminder", () => {
  ...
  test("TC-AG-010 @high @positive — First message is pre-filled and editable", async ({
    ...
    if (value.length > 0) {
      expect(value).toMatch(CREDIT_CARD_PAYMENT_REMINDER_TEMPLATE.expectedFirstMessageSnippet);
    }
