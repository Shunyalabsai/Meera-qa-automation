...
import {
  createDebtRecoveryAgent,
  openAgentEdit,
} from "../../../../../helpers/debt-recovery.helper";
 ...
 */
test.describe("BUILD › Agents › Debt recovery — Full lifecycle @journey @debt-recovery @serial", () => {
  test.describe.configure({ mode: "serial" });

  const agentName = uniqueName("DebtRecovery_Lifecycle");
  const updatedPrompt =
