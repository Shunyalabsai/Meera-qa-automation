...
import {
  ...
  openAgentEdit,
} from "../../../../../helpers/customer-support.helper";
import { CUSTOMER_SUPPORT_TEMPLATE } from "../../../../../data/customer-support-template";
import { uniqueName } from "../../../../../utils/test-data";

test.describe("BUILD › Agents › Customer support — Full lifecycle @journey @customer-support @serial", () => {
  ...
  test("TC-AG-CS-080 @high @positive — Create customer support agent", async ({
    ...
    agentId = await createCustomerSupportAgent(page, {
      name: agentName,
