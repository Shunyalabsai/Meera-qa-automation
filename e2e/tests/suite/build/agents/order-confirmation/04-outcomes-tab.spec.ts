...
test.describe("BUILD › Agents › Order confirmation — Outcomes tab @journey @order-confirmation", () => {
  ...
  test("TC-AG-OC-042 @high @positive — Default extraction fields include orderConfirmed", async ({
    ...
    if (content.trim().length > 0) {
      for (const field of ORDER_CONFIRMATION_TEMPLATE.defaultExtractionFields) {
