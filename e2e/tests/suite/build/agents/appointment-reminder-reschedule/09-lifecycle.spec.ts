...
import {
  createAppointmentReminderRescheduleAgent,
  openAgentEdit,
} from "../../../../../helpers/appointment-reminder-reschedule.helper";
...
test.describe("BUILD › Agents › Appointment Reminder & Reschedule — Full lifecycle @journey @appointment-reminder-reschedule @serial", () => {
  ...
  test("TC-AG-AR-080 @high @positive — Create appointment reminder agent", async ({
    ...
    agentId = await createAppointmentReminderRescheduleAgent(page, {
      name: agentName,
